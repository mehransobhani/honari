                ...
                <div className={['container-fluid'].join(' ')}>
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        <div className={['col-4', 'text-left', 'p-0'].join(' ')}>
                            <img src="/assets/images/main_images/double_up_arrow.png" style={{width: '20px'}} className={['side-filter-toggler'].join(' ')} />
                        </div>
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/sort.png" style={{width: '20px'}} />
                    ...
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        <div className={['col-4', 'text-left', 'p-0'].join(' ')}>
                            <img src="/assets/images/main_images/double_down_arrow.png" style={{width: '20px'}} className={['side-filter-toggler'].join(' ')} />
                        </div>
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/view.png" style={{width: '20px'}} />
                    ...
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        <div className={['col-4', 'text-left', 'p-0'].join(' ')}>
                            <img src="/assets/images/main_images/double_down_arrow.png" style={{width: '20px'}} />
                        </div>
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/layers.png" style={{width: '20px'}} />
                    ...
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        ...
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/star.png" style={{width: '20px'}} />
                    ...
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        ...
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/measure.png" style={{width: '20px'}} />
                    ...
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        ...
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/earth.png" style={{width: '20px'}} />
                    ...
                    <div className={['row', 'mt-4', 'rounded', 'border', 'border-info', 'p-2'].join(' ')}>
                        ...
                        <div className={['col-8', 'text-right', 'p-0', 'd-flex', 'align-items-center'].join(' ')} style={{direction: 'rtl'}} >
                            <img src="/assets/images/main_images/color_palette.png" style={{width: '20px'}} />
                        ...
                        <div className={['container', 'mt-2', 'detail', 'd-none'].join(' ')}>
                            <div className={['row'].join(' ')}>
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_white.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_black.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_red.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_yellow.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_green.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_pink.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_blue.png" style={{width: '20px'}}/>
                                ...
                                <div className={['col-12', 'd-flex', 'justify-content-between', 'align-items-center', 'p-0', 'mt-2'].join(' ')}>
                                    <img src="/assets/images/main_images/circle_brown.png" style={{width: '20px'}}/>
