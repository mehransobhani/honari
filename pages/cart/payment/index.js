...
<div className={['w-100'].join(' ')} style={{display: 'relative', top: '20px'}}>
                        ...
                        <div className={['col-4', 'text-center'].join(' ')}>
                            <img src='/assets/images/main_images/checked_main_circle.png' style={{width: '20px', height: '20px'}} />
                        </div>
                        <div className={['col-4', 'text-center'].join(' ')}>
                            <img src='/assets/images/main_images/checked_main_circle.png' style={{width: '20px', height: '20px'}} />
                        </div>
                        <div className={['col-4', 'text-center'].join(' ')}>
                            <img src='/assets/images/main_images/checked_gray_circle.png' style={{width: '20px', height: '20px'}} />
                        </div>
                    </div>
    */
    return(
